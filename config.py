...
class Config:
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6253659575:AAFZeekFQBsmay7nT4M06XUj9X8rxrhrSgg")
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "Mobile API ID")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "Mobile API ID")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/apiid_apihash_mobilebot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/apiid_apihash_mobilebot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "<b>Managed With ☕️ By @geraimobile</b>")
